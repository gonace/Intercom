...
namespace Intercom.Requests.Visitors
{
    ...
    /// </summary>
    public class ConvertVisitorRequest : PayloadRequest
    {
        /// <summary>
        ...
        public ConvertVisitorRequest(Visitor visitor)
        {
            Type = visitor.Type;
            Id = visitor.Id;
        ...
        public ConvertVisitorRequest(string type, string id, string userId, string email)
        {
            Type = type;
            Id = id;
            UserId = userId;
